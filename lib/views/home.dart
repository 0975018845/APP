...
import 'file:///E:/University/Sollution_Challenge/flutter_5/flutter_app2/lib/models/categori_model.dart';
    ...
    return Scaffold(
      appBar: AppBar(
        title: Row(
          ...
          children: <Widget>[
            Text("Read it!", style: TextStyle(fontSize: 22,color: Colors.white, fontWeight: FontWeight.bold), )
          ],
        ),
        centerTitle: true,
        elevation: 3.0,
